...
async function promptGPTChat(prompt, apiKey, model, maxTokens, dialog) {
  var _a;
...
var AiSummaryPlugin = class extends import_obsidian2.Plugin {
  async generateSummary() {
    ...
    await promptGPTChat(this.generateGPTPrompt(referencedNotes, (_a = frontMatter["prompt"]) != null ? _a : this.settings.defaultPrompt), this.settings.openAiApiKey, this.settings.model, this.settings.maxTokens, dialog);
...
var AiSummarySettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Model").setDesc("Select the model").addDropdown((dropdown) => dropdown.addOption("gpt-3.5-turbo", "gpt-3.5-turbo (16k)").addOption("gpt-4-turbo-preview", "gpt-4-turbo-preview (128k)").setValue(this.plugin.settings.model).onChange(async (value) => {
