...
1. To certify as meeting a predetermined standard; to certify an educational institution as upholding the specified standards necessary for the students to advance.
2. To recognize as outstanding.
3. To credit.
...
1. Administration, or administrative work.
2. A systems administrator; one who maintains a computer system or network.
3. A user of a discussion forum, web site, etc. with privileges allowing them to control or restrict the activity of other uses.
4. To serve as an administrator for or of.
...
4. Attention paid to something; careful regard.
...
1. A copy of a file or record, stored separately from the original, that can be used to recover the original if it is destroyed or damaged.
2. Supporting, reinforcing; of or related to accompaniment

## brainstorm

1. A session of brainstorming, investigating a problem to try to find solutions.
2. To investigate something, or solve a problem using brainstorming.
3. To participate in a brainstorming session.

## checklist

1. A list of tasks to be completed, names to be consulted, conditions to be verified and similar.
2. An inventory, especially of species.
...
1. To make clear or easily understood; to explain in order to remove doubt or obscurity
...
1. A set of individuals in a program, especially when compared to previous sets of individuals within the same program.
...
3. The department of a business that ensures all government regulations are complied with.
...
2. To express willingness, to give permission.
3. To cause to sign a consent form.
4. To grant; to allow; to assent to.
5. To agree in opinion or sentiment; to be of the same mind; to accord; to concur.

## consult

1. The act of consulting or deliberating; consultation
2. The result of consultation; determination; decision.
3. To seek the opinion or advice of another; to take counsel; to deliberate together; to confer.
4. To advise or offer expertise.
5. To work as a consultant or contractor rather than as a full-time employee of a firm.
...
2. A standard or test by which individual things or people may be compared and judged.

## critique

1. An essay in which another piece of work is criticised, reviewed, etc.
...
2. A ceremony marking an official completion or opening.
...
3. In any situation of conflict, an actual instance of active hostilities.
...
1. The act of enrolling or the state of being enrolled.
2. The record of such enrolling; registration.
...
3. A file type.
4. To create or edit the layout of a document.
5. To prepare a mass storage medium for initial use, erasing any existing data in the process.

## formative

1. Denoting forms of assessment used to guide learning rather than to quantify educational outcomes.

## gantt

1. A Gantt chart is a bar chart that illustrates a project schedule. It was designed and popularized by Henry Gantt around the years 1910–1915. Modern Gantt charts also show the dependency relationships between activities and the current schedule status
...
2. The combination with compatible elements in order to incorporate them.
...
1. An important event in a person's life or career, in the history of a nation, in the life of some project, etc.
2. To place milestones along (a road, etc.).
3. To plan out a project as a series of major steps.
...
2. A section of a program; a subroutine or group of subroutines.
...
2. The process during which individuals, groups and organizations are consulted about or have the opportunity to become actively involved in a project or program of activity.

## peer

1. A look; a glance.
2. To look with difficulty, or as if searching for something.
...
3. A collection of assets generally.

## prioritise

1. To arrange or list a group of things in order of priority or importance.
2. To rank something as having high priority.

## questionnaire

1. A form containing a list of questions; a means of gathering information for a survey
2. To survey using questionnaires
...
1. To restrain; to control; to check.
...
1. The act of submitting or giving e.g. a completed piece of work.
...
1. To check or prove the validity of; verify.
...
2. To improve through collaboration.
